  ...
  ;(() => {
    ...
    function dd(e, t = {}) {
      ...
      function k(g, E) {
        ...
        const K = S.toString(2).padStart(3, '0').split('')
      ...
      function f() {
        ...
        for (const [g, E] of so(v)) k(E, p[+g].degree)
        b = setTimeout(() => {
          c && (e.innerHTML = '')
        }, r)
      }
    ...
    var Nd = Object.create,
      ...
      el = It((e, t) => {
        ;((n, r) => {
          ...
          function c(y, k) {
            return y.replace(/\$(\d{1,2})/g, (b, f) => k[f] || '')
          }
          function m(y, k) {
          ...
          function u(y, k, b) {
            if (!y.length || Object.hasOwn(i, y)) return k
          ...
          return (
            ...
            (h.addSingularRule = (y, k) => {
              r.push([s(y), k])
            }),
            (h.addUncountableRule = y => {
              if (typeof y == 'string') {
                i[y.toLowerCase()] = !0
                return
              }
            ...
            [
              ...
              ['pickaxe', 'pickaxes'],
              ['passerby', 'passersby'],
            ].forEach(y => h.addIrregularRule(y[0], y[1])),
            [
              [/s?$/i, 's'],
              [/[^\u0000-\u007F]$/i, '$0'],
              [/([^aeiou]ese)$/i, '$1'],
              ...
              [/m[ae]n$/i, 'men'],
              ['thou', 'you'],
            ].forEach(y => h.addPluralRule(y[0], y[1])),
            [
              [/s$/i, ''],
              [/(ss)$/i, '$1'],
              [
              ...
              [/(eau)x?$/i, '$1'],
              [/men$/i, 'man'],
            ].forEach(y => h.addSingularRule(y[0], y[1])),
            [
              'adulthood',
              'advice',
              'agenda',
            ...
            l === null || typeof l == 'boolean' || typeof l > 'u'
              ...
              : typeof l == 'number'
                ...
                : typeof l == 'string'
                  ...
                  : Array.isArray(l)
                    ? l.reduce(r, '')
                    : n(l) && Object.hasOwn(l.props, 'children')
                      ? i(l.props.children)
                      : ''
      ...
      tl = It((e, t) => {
        ...
        function p(g) {
          return Object.getOwnPropertySymbols
            ? Object.getOwnPropertySymbols(g).filter(E =>
        ...
        function y(g, E) {
          return (
            h(g, E) &&
            !(Object.hasOwn(g, E) && Object.propertyIsEnumerable.call(g, E))
          )
        }
        function k(g, E, S) {
          var T = {}
    ...
    var Jc = w.label(e => ({
      ...
      cs = J(
        (
          ...
          const [f, g] = Te(vo({ error: r, value: y, lastErrorValue: d })),
            E = `${e}-error`
          re(() => {
            g(vo({ error: r, value: y, lastErrorValue: d }))
          }, [y, r, d])
          const S = a.createElement(Xc, {
    ...
    function Ve(e, t) {
      const n = X(() => {
          try {
            const s = sessionStorage.getItem(`${G}/state/${e}`)
    ...
    function Q5(...e) {
      const t = sessionStorage.getItem(`${G}/state`)?.split(';') || []
      e.length
    ...
    function Ee(e) {
      const t = Ht().getChannel()
      if (!t) throw new Error('Channel not available')
      const n = be(Es.subscribe(e, t)),
    ...
    var ru = {
      ...
      dl = () => bt(Cs, 'Controls'),
      ya = () => {
        const e = bt(Ss, 'ControlsDispatch')
        return Et(
          () => ({
      ...
      Tr = () => {
        const { accessToken: e, setAccessToken: t, subdomain: n } = al(),
          { toggleConfig: r } = ya(),
          [i] = Ee(J1),
          l = La(G),
          { projectId: o } = i || {}
...
`,
    ...
    var Zs = () => {
        const [{ token: e }, t] = Bl(`${G}/accessToken`, { token: ut }),
          n = a.useCallback(
            r => {
              ur(r), t({ token: ut })
            },
          ...
          exchanges: [
            ...
            V2(async t => ({
              ...
              willAuthError() {
                ...
                try {
                  if (!Xn) {
                    const { exp: n } = JSON.parse(atob(ut.split('.')[1]))
                    Xn = n
                  }
      ...
      ;(e.assertNever = n),
        ...
        (e.objectKeys =
          typeof Object.keys == 'function'
            ...
            : i => {
                const l = []
                for (const o in i) Object.hasOwn(i, o) && l.push(o)
                return l
              }),
        (e.find = (i, l) => {
    ...
    var fe = class extends Q {
      ...
      pick(e) {
        const t = {}
        for (const n of ae.objectKeys(e))
          e[n] && this.shape[n] && (t[n] = this.shape[n])
        return new fe({ ...this._def, shape: () => t })
      }
      omit(e) {
        const t = {}
        for (const n of ae.objectKeys(this.shape))
    ...
    var da = class extends Q {
      _parse(e) {
        ...
        function r(i) {
          ...
          const l = i.map(o => new qe(o.ctx.common.issues))
...
`),
      ...
      f4 = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        const [r, i] = Ve('authenticationScreen', n ? 'signin' : 'welcome'),
...
`),
      S4 = ({ projectId: e, configFile: t, goToNext: n }) => {
        ...
        const [{ data: r, fetching: i, error: l }] = bl({
          query: C4,
...
`),
    ...
    function O4({
      ...
      const [{ data: r, fetching: i, error: l }, o] = bl({ query: L4 })
      re(() => {
        const f = setInterval(o, 5e3)
        return () => clearInterval(f)
      }, [o])
      const [s, d] = Ve('selectedAccountId'),
        c = r?.viewer?.accounts.find(f => f.id === s),
        m = X(f => d(f.id), [d])
      re(() => {
        !s && r?.viewer?.accounts && m(r.viewer.accounts[0])
      }, [r, s, m])
      const [u, p] = Ve('isSelectingProject', !1),
        v = X(
          f => {
            p(!0), n(f.id)
            const g = setTimeout(() => {
    ...
    var Jo = {
      ...
      Qs = ({ children: e, billingUrl: t, suspensionReason: n = 'OTHER' }) => {
        ...
        const { heading: r, message: i, action: l } = Jo[n] || Jo.OTHER
        return a.createElement(
          pe,
          { footer: null },
          a.createElement(
    ...
    function q4(e, t) {
      ...
      for (const n of e.entries()) if (!Ae(n[1], t.get(n[0]))) return !1
      return !0
    }
    function G4(e, t) {
      if (e.size !== t.size) return !1
    ...
    function Ae(e, t) {
      ...
      if (e && Xo(e) && t && Xo(t)) {
        ...
        for (let i = n.length; i-- !== 0; )
          if (!Object.hasOwn(t, n[i])) return !1
        for (let i = n.length; i-- !== 0; ) {
          const l = n[i]
    ...
    function o0(e, t, n, r, i) {
      ...
      var o = xl(n, r, l, i),
        ...
        d = Object.keys(s)
          .map(p => Ue({ key: p }, s[p], { area: hp(s[p]) }))
          .sort((p, v) => v.area - p.area),
        c = d.filter(p => {
          var v = p.width,
            h = p.height
    ...
    function f0(e, t, n) {
      var r = Ca(e, s => {
        ...
        i = !!r && e.some(s => s.name === n && s.enabled && s.order < r.order)
      if (!i) {
        var l = '`' + t + '`',
          o = '`' + n + '`'
        console.warn(
    ...
    function Op(e, t, n, r) {
      var i = [0, 0],
        ...
        s = o.indexOf(Ca(o, m => m.search(/,|\s/) !== -1))
      o[s] &&
        o[s].indexOf(',') === -1 &&
        console.warn(
        ...
        function e(t, n) {
          ...
          up(this, e),
            ...
            (this.modifiers = Object.keys(this.options.modifiers)
              .map(o => Ue({ name: o }, this.options.modifiers[o]))
    ...
    O.arrayOf = (e, t) =>
      !O.array(e) && !O.function(t) ? !1 : e.every(n => t(n))
    O.asyncGeneratorFunction = e => Pr(e) === 'AsyncGeneratorFunction'
    O.asyncFunction = nt('AsyncFunction')
    O.bigint = _n('bigint')
    O.boolean = e => e === !0 || e === !1
    O.date = nt('Date')
    O.defined = e => !O.undefined(e)
    O.domElement = e =>
      O.object(e) &&
      !O.plainObject(e) &&
      e.nodeType === 1 &&
    ...
    O.generator = e =>
      O.iterable(e) && O.function(e.next) && O.function(e.throw)
    O.generatorFunction = nt('GeneratorFunction')
    O.instanceOf = (e, t) =>
      !e || !t ? !1 : Object.getPrototypeOf(e) === t.prototype
    O.iterable = e => !O.nullOrUndefined(e) && O.function(e[Symbol.iterator])
    O.map = nt('Map')
    O.nan = e => Number.isNaN(e)
    O.null = e => e === null
    O.nullOrUndefined = e => O.null(e) || O.undefined(e)
    O.number = e => _n('number')(e) && !O.nan(e)
    O.numericString = e =>
      O.string(e) && e.length > 0 && !Number.isNaN(Number(e))
    O.object = e =>
      !O.nullOrUndefined(e) && (O.function(e) || typeof e == 'object')
    O.oneOf = (e, t) => (O.array(e) ? e.indexOf(t) > -1 : !1)
    ...
    O.primitive = e => O.null(e) || Up(typeof e)
    ...
    var Wp = v0('function'),
      ...
      p1 = e => !Gp(e) && !qp(e) && (Wp(e) || typeof e == 'object'),
      Gp = v0('undefined'),
      qi = e => {
    ...
    Z.arrayOf = (e, t) =>
      !Z.array(e) && !Z.function(t) ? !1 : e.every(n => t(n))
    Z.asyncGeneratorFunction = e => Vr(e) === 'AsyncGeneratorFunction'
    Z.asyncFunction = at('AsyncFunction')
    Z.bigint = On('bigint')
    Z.boolean = e => e === !0 || e === !1
    Z.date = at('Date')
    Z.defined = e => !Z.undefined(e)
    Z.domElement = e =>
      Z.object(e) &&
      !Z.plainObject(e) &&
      e.nodeType === 1 &&
    ...
    Z.generator = e =>
      Z.iterable(e) && Z.function(e.next) && Z.function(e.throw)
    Z.generatorFunction = at('GeneratorFunction')
    Z.instanceOf = (e, t) =>
      !e || !t ? !1 : Object.getPrototypeOf(e) === t.prototype
    Z.iterable = e => !Z.nullOrUndefined(e) && Z.function(e[Symbol.iterator])
    Z.map = at('Map')
    Z.nan = e => Number.isNaN(e)
    Z.null = e => e === null
    Z.nullOrUndefined = e => Z.null(e) || Z.undefined(e)
    Z.number = e => On('number')(e) && !Z.nan(e)
    Z.numericString = e =>
      Z.string(e) && e.length > 0 && !Number.isNaN(Number(e))
    Z.object = e =>
      !Z.nullOrUndefined(e) && (Z.function(e) || typeof e == 'object')
    Z.oneOf = (e, t) => (Z.array(e) ? e.indexOf(t) > -1 : !1)
    ...
    Z.primitive = e => Z.null(e) || a3(typeof e)
    ...
    function r3() {
      ...
      return e.every(n => U.string(n) || U.array(n) || U.plainObject(n))
    }
    function i3(e, t, n) {
      return y0(e, t)
        ? [e, t].every(U.array)
    ...
    function f1(e, t, n) {
      ...
      return [o, s].every(U.array)
        ...
        : [o, s].every(U.plainObject)
          ...
          : ![o, s].every(m => U.primitive(m) && U.defined(m)) &&
            (i === 'added'
    ...
    function v1(e) {
      return t => {
        var n = t[0],
          r = t[1]
        return U.array(e)
          ? Re(e, r) || e.some(i => Re(i, r) || (U.array(r) && Al(r)(i)))
          : U.plainObject(e) && e[n]
            ? !!e[n] && Re(e[n], r)
            : Re(e, r)
      }
    ...
    function y1(e) {
      return t =>
        U.array(e)
          ? e.some(n => Re(n, t) || (U.array(t) && Al(t)(n)))
          : Re(e, t)
    }
    function zn(e, t) {
      return U.array(e) ? e.some(n => Re(n, t)) : Re(e, t)
    }
    function Al(e) {
    ...
    function o3(e, t) {
      if ([e, t].some(U.nullOrUndefined))
        throw new Error('Missing required parameters')
      if (![e, t].every(u => U.plainObject(u) || U.array(u)))
        throw new Error('Expected plain objects or array')
      var n = (u, p) => {
          try {
    ...
    function b1(e, t) {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        t &&
          (r = r.filter(i => Object.getOwnPropertyDescriptor(e, i).enumerable)),
          n.push.apply(n, r)
      }
      return n
    }
    function me(e) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2
          ? b1(Object(n), !0).forEach(r => {
              xe(e, r, n[r])
            })
          : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
            : b1(Object(n)).forEach(r => {
      ...
      Ll = (e => {
        ...
        function n(r) {
          ...
          return (
            Sa(this, n),
            (i = t.call(this, r)),
            xe(wt(i), 'setArrowRef', l => {
              i.arrowRef = l
            }),
            xe(wt(i), 'setChildRef', l => {
              i.childRef = l
            }),
            xe(wt(i), 'setFloaterRef', l => {
              i.floaterRef = l
            }),
            xe(wt(i), 'setWrapperRef', l => {
              i.wrapperRef = l
            }),
            xe(wt(i), 'handleTransitionEnd', () => {
              ...
              value: function () {
                ...
                if (u === 'center') this.setState({ status: ne.IDLE })
                  ...
                  new u1(i, this.floaterRef, {
                    ...
                    onUpdate: E => {
                      this.popper = E
                      var S = this.state.currentPlacement
                      this._isMounted &&
                        E.placement !== S &&
                  ...
                  new u1(this.target, this.wrapperRef, {
                    ...
                    onCreate: E => {
                      ;(this.wrapperPopper = E),
                        this._isMounted &&
                          this.setState({ statusWrapper: ne.IDLE }),
                        d(E, 'wrapper'),
                        u !== E.placement &&
                          setTimeout(() => {
                            E.instance.update()
    ...
    xe(Ll, 'propTypes', {
      ...
      content: k1(A.default.node, e => !e.component),
    ...
    function O3(e, t, n) {
      ...
      let o = N0(e),
        ...
        u = (r = o?.top) != null ? r : 0
      if (d && c) {
        const p = (i = e?.offsetTop) != null ? i : 0,
    ...
    var K3 = Y3,
      J3 = class extends Vt {
        ...
        render() {
          ...
          if (A0() === 'safari') {
            const { mixBlendMode: s, zIndex: d, ...c } = i
    ...
    var r7 = a7,
        ...
        constructor() {
          super(...arguments),
            ...
            R(this, 'setPopper', (e, t) => {
              var n
              const { action: r, lifecycle: i, step: l, store: o } = this.props
              t === 'wrapper'
      ...
      O0 = class extends Vt {
        constructor(e) {
          ...
          const { debug: t, getHelpers: n, run: r = !0, stepIndex: i } = e
        ...
        componentDidUpdate(e, t) {
          if (!_t()) return
          const { action: n, controlled: r, index: i, status: l } = this.state,
          ...
          const $ = { ...this.state, index: i, step: E }
          if (
            f('action', [oe.NEXT, oe.PREV, oe.SKIP, oe.CLOSE]) &&
            f('status', ee.PAUSED)
          ) {
            const K = rn(this.props, c[t.index])
            this.callback({
              ...$,
              index: t.index,
              lifecycle: q.COMPLETE,
        ...
        scrollToStep(e) {
          ...
          if (r === ee.RUNNING && p) {
            ...
            if (n === q.BEACON && k) {
              const { offsets: f, placement: g } = k
              !['bottom'].includes(g) &&
                !v &&
                (y = Math.floor(f.popper.top - s))
            } else if (n === q.TOOLTIP && b) {
              const { flipped: f, offsets: g, placement: E } = b
    ...
    var d7 = e => {
      ...
      c7 = (e, t) => {
        const n = e.filter(i => i.comparisons.some(Z0)),
          r = n.length ? n : e
...
`),
      b7 = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        const [{ data: i, error: l, operation: o }, s] = bl({
          query: p7,
          variables: {
            projectId: e,
            storyId: t,
      ...
      E7 = () => bt(Tl, 'Build'),
      B0 = () => {
        const { selectedBuild: e } = bt(Tl, 'Build')
    ...
    var V0 = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
        const { emoji: r, renderProgress: i } = _l[e.currentStep],
          l = i(e)
    ...
    var R7 =
      ...
      Q7 = ({
        ...
        const { isRunning: s, startBuild: d } = Ea(),
          [c, m] = Ve('showInitialBuild', n)
        re(() => {
          n && m(!0)
        }, [n, m])
        const [u, p] = Ve('showCatchAChange', !c),
      ...
      gh = ({
        ...
        const o = n.map(({ browser: s, result: d }) => ({
          id: s.id,
          title: s.name,
          icon: R1[s.key],
          right:
    ...
    function Gn(e) {
      return function (t) {
        ...
        var o = l[0],
          ...
          d = Array.isArray(s) ? Gh(s, u => u.test(o)) : qh(s, u => u.test(o)),
          c
    ...
    function qh(e, t) {
      for (var n in e) if (Object.hasOwn(e, n) && t(e[n])) return n
    }
    function Gh(e, t) {
  ...
  `,
    ...
    var S6 = ({
        ...
        const { isRunning: o, startBuild: s, stopBuild: d } = Ea(),
          {
            lastBuildOnBranch: c,
...
`),
      ...
      M6 = e => {
        const [t, n] = Ve('selectedBuildInfo')
      ...
      H6 = () => {
        ...
        const $ = !N && E !== 'test-provider-state:crashed',
          K = X(() => {
            $ && S()
          }, [$, S])
        ...
        const le = X(
            ve => {
              if ((n({ selectedPanel: pn }), r(!0), b && g !== 'story')) {
                const we = Object.keys(b).indexOf(f),
