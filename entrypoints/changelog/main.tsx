  ...
  <div className='min-h-screen bg-background py-16 px-4 sm:px-6 lg:px-8'>
    <div className='max-w-4xl mx-auto'>
      <div className='text-center mb-16'>
        <h1 className='text-5xl font-extrabold text-primary sm:text-6xl sm:tracking-tight'>
      ...
      <div className='space-y-12'>
        {CHANGELOG.map(item => (
          <Card
            key={item.version}
            className='overflow-hidden shadow-xl rounded-xl hover:shadow-2xl transition-shadow duration-300 border-t-4 border-primary'
          >
            <div className='px-8 py-10 sm:p-12'>
              <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
                ...
                <div className='mt-2 sm:mt-0 inline-flex px-5 py-2 rounded-full text-sm font-semibold bg-secondary text-secondary-foreground'>
                  {item.date}
                </div>
              </div>
                ...
                <ul className='space-y-6'>
                  {item.features.map(feature => (
                    <li
                      ...
                      className='flex items-start group hover:bg-accent/10 p-3 rounded-lg transition-colors duration-200'
                    >
                      <div className='flex-shrink-0'>
                        <Check
                          aria-hidden='true'
                          className='h-6 w-6 text-chart-1 group-hover:text-chart-4 transition-colors duration-200'
                        />
                      </div>
                      <p
