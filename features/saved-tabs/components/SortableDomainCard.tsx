...
import { SortableDomainCardProps } from "@/types/saved-tabs";
import { handleSaveKeywords } from "@/utils/handleSaveKeywords";
import { DragEndEvent, useSensors, useSensor, PointerSensor, KeyboardSensor, DndContext, closestCenter } from "@dnd-kit/core";
import { useSortable, arrayMove, sortableKeyboardCoordinates, SortableContext, verticalListSortingStrategy } from "@dnd-kit/sortable";
import { GripVertical, Settings, ExternalLink, Trash } from "lucide-react";
